...
final class DefaultUnleashContextProvider implements UnleashContextProvider, SettableUnleashContextProvider
{
     ...
     */
    public function __construct($defaultContext = null)
    {
     ...
     */
    public function setDefaultContext($context): \Unleash\Client\ContextProvider\SettableUnleashContextProvider
    {

...
final class UnleashEvents
{
     ...
     */
    const FEATURE_TOGGLE_NOT_FOUND = 'unleash.event.toggle.not_found';
     ...
     */
    const FEATURE_TOGGLE_DISABLED = 'unleash.event.toggle.disabled';
     ...
     */
    const FEATURE_TOGGLE_MISSING_STRATEGY_HANDLER = 'unleash.event.toggle.missing_strategy_handler';
     ...
     */
    const FETCHING_DATA_FAILED = 'unleash.event.server.fetching_failed';
     ...
     */
    const IMPRESSION_DATA = 'unleash.events.impression_data';
}

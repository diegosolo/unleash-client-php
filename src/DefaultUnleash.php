...
final class DefaultUnleash implements Unleash
{
     ...
     */
    public function __construct($strategyHandlers, UnleashRepository $repository, RegistrationService $registrationService, UnleashConfiguration $configuration, MetricsHandler $metricsHandler, VariantHandler $variantHandler)
    {

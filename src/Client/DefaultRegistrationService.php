...
final class DefaultRegistrationService implements RegistrationService
{
    ...
    private $sdkVersion;
    /**
     * @param string|null $sdkName
     * @param string|null $sdkVersion
     */
    public function __construct(ClientInterface $httpClient, RequestFactoryInterface $requestFactory, UnleashConfiguration $configuration, $sdkName = null, $sdkVersion = null)
    {
     ...
     * @return void
     */
    private function storeCache(bool $result)
    {
